...
;(!(function (a) {
  ...
  'function' == typeof define && define.amd
    ? define('jquery-bridget/jquery.bridget', ['examples/resources/js/jquery'], c)
    : c(a.jQuery)
})(window),
  (function (a) {
    function b(b) {
      ...
      ;(b(h.prototype, a.prototype),
        ...
        (h.prototype.layoutPosition = function () {
          var a = this.layout.size,
            ...
            c = {}
          ;(b.isOriginLeft
            ? ((c.left = this.position.x + a.paddingLeft + 'px'), (c.right = ''))
            : ((c.right = this.position.x + a.paddingRight + 'px'), (c.left = '')),
            b.isOriginTop
              ? ((c.top = this.position.y + a.paddingTop + 'px'), (c.bottom = ''))
              : ((c.bottom = this.position.y + a.paddingBottom + 'px'), (c.top = '')),
            this.css(c),
    ...
    function g(c, g, l, n, o, p) {
      ...
      return (
        ...
        (q.prototype._find = function (a) {
          return a
            ? ('string' == typeof a && (a = this.element.querySelectorAll(a)), (a = d(a)))
            : void 0
        }),
    ...
    function b(a, b) {
      ...
      return (
        ...
        (d.prototype._manageStamp = function (a) {
          ...
          for (
            var i = (this.options.isOriginTop ? d.top : d.bottom) + c.outerHeight, j = g;
            h >= j;
            j++
          )
